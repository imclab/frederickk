 ...
 * Ken Frederick
 * 
 * Example showing the usage of the FConvert class
 *
...
void setup() {
  ...
  //-----------------------------------------------------------------------------
  // there is no need to instantiate the FConvert class
  //-----------------------------------------------------------------------------
   ...
   */
  println();
  println("FConvert.reverse( integerExample )");
  FConvert.reverse( integerExample );
  for(int i=0; i<integerExample.length; i++) {
    println(integerExample[i]);
  } 
   ...
   */
  println();
  println("FConvert.toPrimitive( integerExample )");
  int[] tempInt1 = FConvert.toPrimitive( integerExample );
  for(int i=0; i<integerExample.length; i++) {
  ...
  println();
  println("FConvert.toPrimitive( integerExample )");
  float[][] temp2D = (float[][]) FConvert.to2DArray( PVectorList );
